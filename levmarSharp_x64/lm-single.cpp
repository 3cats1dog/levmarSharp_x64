...
#define LEVMAR_FDIF_FORW_JAC_APPROX slevmar_fdif_forw_jac_approx 
#define LEVMAR_FDIF_CENT_JAC_APPROX slevmar_fdif_cent_jac_approx 
#define LEVMAR_TRANS_MAT_MAT_MULT   slevmar_trans_mat_mat_mult 
#define LEVMAR_L2NRMXMY             slevmar_L2nrmxmy 
#define LEVMAR_COVAR                slevmar_covar
