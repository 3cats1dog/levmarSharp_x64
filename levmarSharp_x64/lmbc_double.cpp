...
#define FUNC_STATE  dfunc_state
#define LNSRCH dlnsrch 
#define BOXPROJECT dboxProject 
#define BOXSCALE dboxScale 
#define LEVMAR_BOX_CHECK dlevmar_box_check 
#define VECNORM dvecnorm 
#define LEVMAR_BC_DER dlevmar_bc_der 
#define LEVMAR_BC_DIF dlevmar_bc_dif 
#define LEVMAR_FDIF_FORW_JAC_APPROX dlevmar_fdif_forw_jac_approx 
#define LEVMAR_FDIF_CENT_JAC_APPROX dlevmar_fdif_cent_jac_approx 
#define LEVMAR_TRANS_MAT_MAT_MULT dlevmar_trans_mat_mat_mult 
#define LEVMAR_L2NRMXMY dlevmar_L2nrmxmy 
#define LEVMAR_COVAR dlevmar_covar 
#define LMBC_DIF_DATA dlmbc_dif_data 
#define LMBC_DIF_FUNC dlmbc_dif_func 
#define LMBC_DIF_JACF dlmbc_dif_jacf 
